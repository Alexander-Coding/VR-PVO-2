...
4) СТРЕЛЬБА, ГИЛЬЗЫ, ДЫМ И ПЕРЕГРЕВ
   • Стрельба: кнопка активации (триггер) или зажатая ЛКМ (Fire1). Пока держите m60, при выстреле — выброс гильз, случайный звук tush_net_1..4, дым из ствола (Muzzle Smoke).
   • Непрерывная стрельба: можно зажать ЛКМ/триггер — стрельба идёт без остановки с интервалом fireRate. Через случайное время (30–45 с по умолчанию) пушка перегревается: 5 с остывания, проигрывается звук пара (steam.mp3), затем снова можно стрелять.
   • Звук пара при перегреве: в M60 VR Shoot поле Steam Sound — перетащите Assets/Sound/steam.mp3 или положите steam.mp3 в Assets/Resources/Sound/.
